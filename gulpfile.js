...
if (gulpVersion == 3) {
	...
	var taskArr = ['styles', 'templates', 'scripts', 'browser-sync'];
...
if (gulpVersion == 4) {
	...
	gulp.task('watch', function() {
		...
		gulp.watch('app/templates/**/*.pug', gulp.parallel('templates'));
		gulp.watch(['libs/**/*.js', 'app/js/common.js'], gulp.parallel('scripts'));
		gulp.watch('app/*.html', gulp.parallel('code'));
		gmWatch && gulp.watch('app/img/_src/**/*', gulp.parallel('img')); // GraphicsMagick watching image sources if allowed.
	});
	gmWatch ? gulp.task('default', gulp.parallel('img', 'styles', 'templates', 'scripts', 'browser-sync', 'watch')) 
					: gulp.task('default', gulp.parallel('styles', 'templates', 'scripts', 'browser-sync', 'watch'));
